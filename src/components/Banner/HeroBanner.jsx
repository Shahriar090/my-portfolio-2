      ...
      >
        ...
        <div className="content absolute text-center top-[35%] left-[0%] md:left-[10%] transform translate(-50%, -50%)">
          <div className="texts flex flex-col gap-6 pl-2 sm:pl-0">
            <span className="text-xl sm:text-2xl text-white font-medium capitalize text-start sm:text-center">
              Hey There, I am
            </span>
            ...
            <p className="text-[#707070] max-w-lg font-medium text-lg text-start sm:text-center">
          ...
          <div className="mt-6 flex justify-start sm:justify-center pl-2 sm:pl-0">
