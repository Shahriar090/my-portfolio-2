      ...
      <Container>
        <div className="section-container flex flex-col md:flex-row gap-16 md:gap-5 lg:gap-0 items-center justify-center pt-20 md:pt-28">
          <div className="texts flex-[2] space-y-5">
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-semibold capitalize text-gray-200">
          ...
          <div className="img w-3/5 md:w-2/5 flex-[1]">
            <picture>
              <img src={myImg} alt="My Photo" className="rounded-xl" />
            </picture>
          </div>
        </div>
      </Container>
