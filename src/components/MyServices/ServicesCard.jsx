  ...
  return (
    <div className="w-full p-2 bg-[#222222]  rounded-md border border-[#333] cursor-pointer hover:border-[#FF5D56] transition-all duration-500">
      <div className="service-container w-full h-full mt-8">
        <div className="img h-20 w-20 sm:mx-auto">
          <img
            src={serviceImg}
            alt="Service Image"
        ...
        <div className="details text-start sm:text-center mt-6">
          <h2 className="text-[#F1FFFF] text-xl font-bold capitalize">
            {service}
          </h2>
          <p className="text-[#707070] text-[16px] pt-6 text-start sm:text-center max-w-sm mx-auto">
            {description}
          </p>
        </div>
      </div>
